package rtlib.microscope.lightsheet.calibrator._old;
...
import rtlib.microscope.lightsheet.calibrator.utils.GeometryUtils;
		...
		try
		{
			...
			if (lPlayQueueAndWait)
				for (int i = 0; i < mNumberOfDetectionArmDevices; i++)
				{
					...
					final Vector2D[] lPoints = ImageAnalysisUtils.findBrightestPointsForEachPlane(lImage);
