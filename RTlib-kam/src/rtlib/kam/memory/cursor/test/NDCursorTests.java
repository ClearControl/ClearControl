...
public class NDCursorTests
{
	...
	{
		NDBoundedCursor lCursor = NDBoundedCursor.createNDVectorCursor(3, 5, 7, 11);
	...
	public void test2D()
	{
		NDBoundedCursor lCursor = NDBoundedCursor.create2DCursor(1000, 1000);
	...
	public void test3D()
	{
		NDBoundedCursor lCursor = NDBoundedCursor.create3DCursor(100, 100, 100);
		...
		for (int x = 0; x < 100; x++)
		{
			...
			for (int y = 0; y < 100; y++)
			{
				...
				for (int z = 0; z < 100; z++)
				{
					...
					assertEquals(x + 100 * y + 100 * 100 * z,
												lCurrentFlatIndex);
	...
	{
		NDBoundedCursor lCursor = NDBoundedCursor.createNDCursor(100L, 100L, 100L);
	...
	{
		NDBoundedCursor lCursor = NDBoundedCursor.createNDVectorCursor(3, 100, 100, 100);
