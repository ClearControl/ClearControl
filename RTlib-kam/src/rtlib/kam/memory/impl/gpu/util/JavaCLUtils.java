package rtlib.kam.memory.impl.gpu.util;
...
public class JavaCLUtils
{
	...
	public static void readImage3D(	CLImage pCLImage,
																	CLQueue pCLQueue,
																	Pointer<?> pPointer,
																	long pX,
																	long pY,
																	...
																	long pDepth)
	{
		try
		{
			JavaCLUtils.sReadMethod.invoke(	pCLImage,
																			pCLQueue,
	...
	public static void writeImage3D(CLImage pImageCL,
																	CLQueue pCLQueue,
																	Pointer<?> pPointer,
																	long pX,
																	long pY,
																	...
																	long pDepth)
	{
		try
		{
			JavaCLUtils.sWriteMethod.invoke(pImageCL,
																			pCLQueue,
																			pointerToSizeTs(pX, pY, pZ),
																			pointerToSizeTs(pWidth,
																											pHeight,
