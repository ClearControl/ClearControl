...
public class DirettoreLibrary {
	...
	public static void direttoreClose(Pointer<Pointer<Integer > > FPGAReference, Pointer<TD1 > ErrorOut) {
		direttoreClose(Pointer.getPeer(FPGAReference), Pointer.getPeer(ErrorOut));
	}
	@Name("DirettoreClose") 
	protected native static void direttoreClose(@Ptr long FPGAReference, @Ptr long ErrorOut);
	/**
	 * DirettoreOpen<br>
	...
	public static void direttoreOpen(int TriggerFIFODepth, int MatrixFIFODepth, Pointer<Pointer<Integer > > FPGAReference, Pointer<TD1 > ErrorOut) {
		direttoreOpen(TriggerFIFODepth, MatrixFIFODepth, Pointer.getPeer(FPGAReference), Pointer.getPeer(ErrorOut));
	}
	@Name("DirettoreOpen") 
	protected native static void direttoreOpen(int TriggerFIFODepth, int MatrixFIFODepth, @Ptr long FPGAReference, @Ptr long ErrorOut);
	/**
	 * DirettoreStart<br>
	...
	public static void direttoreStart(Pointer<Pointer<Integer > > FPGAReference, Pointer<TD1 > ErrorOut) {
		direttoreStart(Pointer.getPeer(FPGAReference), Pointer.getPeer(ErrorOut));
	}
	@Name("DirettoreStart") 
	...
	public static void direttoreStop(Pointer<Pointer<Integer > > FPGAReference, Pointer<TD1 > ErrorOut) {
		direttoreStop(Pointer.getPeer(FPGAReference), Pointer.getPeer(ErrorOut));
	}
	@Name("DirettoreStop") 
