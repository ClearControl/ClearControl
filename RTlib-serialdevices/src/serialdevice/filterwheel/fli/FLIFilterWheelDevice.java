package serialdevice.filterwheel.fli;

import rtlib.core.configuration.MachineConfiguration;
import rtlib.core.variable.VariableListenerAdapter;
import rtlib.core.variable.doublev.DoubleVariable;
import rtlib.serial.SerialDevice;
import serialdevice.filterwheel.fli.adapters.FilterWheelPositionDeviceAdapter;
import serialdevice.filterwheel.fli.adapters.FilterWheelSpeedDeviceAdapter;
...
public class FLIFilterWheelDevice extends SerialDevice
{
	...
	{
		this(MachineConfiguration.getCurrentMachineConfiguration().getSerialDevicePort("filterwheel.fli",pDeviceIndex,"NULL"));
	}
