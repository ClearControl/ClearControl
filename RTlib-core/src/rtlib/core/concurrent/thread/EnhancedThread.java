...
public abstract class EnhancedThread implements Runnable
{
	...
	{
		return Magnitudes.nano2micro(System.nanoTime());
	}

	public static double getTimeInMilliseconds()
	{
		return Magnitudes.nano2milli(System.nanoTime());
	}

	public static double getTimeInSeconds()
	{
		return Magnitudes.nano2unit(System.nanoTime());
	}
	...
	public static void sleepNanos(final long pNanosecondsToWait)
	{
		...
		sleepNanos(	pNanosecondsToWait,
								(long) Magnitudes.micro2nano(500),
								(long) Magnitudes.micro2nano(100));
	}
