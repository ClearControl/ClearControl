...
import rtlib.cameras.devices.sim.StackCameraDeviceSimulatorHint;
		...
		AsynchronousSchedulerServiceAccess
{
	...
	public StackCameraDevice(	StackSourceInterface<T, A> pStackSource,
			T pType,
			BooleanVariable pTriggerVariable)
	{
		...
		{
			severe(	"cameras",
					"Cannot instantiate " + StackCameraDevice.class.getSimpleName()
