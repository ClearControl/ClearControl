...
public class UtilTests {
    ...
    public void copyTest() {
        long[] dims = {10, 10, 10};
        OffHeapPlanarImg<UnsignedShortType, ShortOffHeapAccess> img =(OffHeapPlanarImg<UnsignedShortType, ShortOffHeapAccess>) new OffHeapPlanarImgFactory<>().createShortInstance(dims,
                new Fraction());
//        OffHeapPlanarImg<UnsignedShortType, ShortOffHeapAccess> img = new OffHeapPlanarImg<UnsignedShortType,
//                ShortOffHeapAccess>(dims, new Fraction());
        ...
        long[] dimstocopy = {5,5,5};
        OffHeapPlanarImg<UnsignedShortType, ShortOffHeapAccess> img1 =(OffHeapPlanarImg<UnsignedShortType,
                ShortOffHeapAccess>) new OffHeapPlanarImgFactory<>().createShortInstance(dimstocopy,
                new Fraction());
        ...
        for (int i = 0; i < 5; i++) {
            for (int j = 0; j < 5; j++) {
                for (int k = 0; k < 5; k++) {
                    ...
                    System.out.println("prao pos: " + prao.getIntPosition(0) + " " + prao.getIntPosition(1) + " " +
