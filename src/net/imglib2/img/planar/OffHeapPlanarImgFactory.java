                                    ...
                                    extends NativeImgFactory<T>
{
                                                            ...
                                                            final T type)
  {
    ...
    final int lLastDimension = (int) dimensions[lNumberOfDimensions
                                                - 1];
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, ByteOffHeapAccess> lInstance =
                                                           (OffHeapPlanarImg<T, ByteOffHeapAccess>) createByteInstance(lFragmentedMemory,
                                                                                                                       dimensions,
                                                                                                                       type);
                                                            ...
                                                            final T type)
  {
    ...
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, CharOffHeapAccess> lInstance =
                                                           (OffHeapPlanarImg<T, CharOffHeapAccess>) createCharInstance(lFragmentedMemory,
                                                                                                                       dimensions,
                                                                                                                       type);
    lInstance.setContiguousMemory(pContiguousMemory);
    return lInstance;
                                                                ...
                                                                final T type)
  {
    ...
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, DoubleOffHeapAccess> lInstance =
                                                             (OffHeapPlanarImg<T, DoubleOffHeapAccess>) createDoubleInstance(lFragmentedMemory,
                                                                                                                             dimensions,
                                                                                                                             type);
    lInstance.setContiguousMemory(pContiguousMemory);
    return lInstance;
                                                              ...
                                                              final T type)
  {
    ...
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, FloatOffHeapAccess> lInstance =
                                                            (OffHeapPlanarImg<T, FloatOffHeapAccess>) createFloatInstance(lFragmentedMemory,
                                                                                                                          dimensions,
                                                                                                                          type);
    lInstance.setContiguousMemory(pContiguousMemory);
    return lInstance;
                                                          ...
                                                          final T type)
  {
    ...
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, IntOffHeapAccess> lInstance =
                                                          (OffHeapPlanarImg<T, IntOffHeapAccess>) createIntInstance(lFragmentedMemory,
                                                                                                                    dimensions,
                                                                                                                    type);
    lInstance.setContiguousMemory(pContiguousMemory);
    return lInstance;
                                                            ...
                                                            final T type)
  {
    ...
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, LongOffHeapAccess> lInstance =
                                                           (OffHeapPlanarImg<T, LongOffHeapAccess>) createLongInstance(lFragmentedMemory,
                                                                                                                       dimensions,
                                                                                                                       type);
    lInstance.setContiguousMemory(pContiguousMemory);
    return lInstance;
                                                              ...
                                                              final T type)
  {
    ...
    final FragmentedMemory lFragmentedMemory =
                                             FragmentedMemory.split(pContiguousMemory,
                                                                    lLastDimension);
    final OffHeapPlanarImg<T, ShortOffHeapAccess> lInstance =
                                                            (OffHeapPlanarImg<T, ShortOffHeapAccess>) createShortInstance(lFragmentedMemory,
                                                                                                                          dimensions,
                                                                                                                          type);
    lInstance.setContiguousMemory(pContiguousMemory);
    return lInstance;
                                                            ...
                                                            final T type)
  {
    ...
    final OffHeapPlanarImg<T, ByteOffHeapAccess> lOffHeapPlanarImg =
                                                                   (OffHeapPlanarImg<T, ByteOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                         dimensions);
    ...
    for (ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      if (mAddSafetyWrapper)
        lContiguousMemoryInterface =
                                   new SafeContiguousMemory(lContiguousMemoryInterface);
      final ByteOffHeapAccess lByteBufferAccess =
                                                new ByteOffHeapAccess(lContiguousMemoryInterface);
  ...
  {
    @SuppressWarnings("unchecked")
    final OffHeapPlanarImg<T, CharOffHeapAccess> lOffHeapPlanarImg =
                                                                   (OffHeapPlanarImg<T, CharOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                         dimensions);
    ...
    for (ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      if (mAddSafetyWrapper)
        lContiguousMemoryInterface =
                                   new SafeContiguousMemory(lContiguousMemoryInterface);
      final CharOffHeapAccess lCharOffHeapAccess =
                                                 new CharOffHeapAccess(lContiguousMemoryInterface);
  ...
  {
    @SuppressWarnings("unchecked")
    final OffHeapPlanarImg<T, DoubleOffHeapAccess> lOffHeapPlanarImg =
                                                                     (OffHeapPlanarImg<T, DoubleOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                             dimensions);
    ...
    for (ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      if (mAddSafetyWrapper)
        lContiguousMemoryInterface =
                                   new SafeContiguousMemory(lContiguousMemoryInterface);
      final DoubleOffHeapAccess lDoubleOffHeapAccess =
                                                     new DoubleOffHeapAccess(lContiguousMemoryInterface);
  ...
  {
    @SuppressWarnings("unchecked")
    final OffHeapPlanarImg<T, FloatOffHeapAccess> lOffHeapPlanarImg =
                                                                    (OffHeapPlanarImg<T, FloatOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                           dimensions);
    ...
    for (ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      if (mAddSafetyWrapper)
        lContiguousMemoryInterface =
                                   new SafeContiguousMemory(lContiguousMemoryInterface);
      final FloatOffHeapAccess lFloatOffHeapAccess =
                                                   new FloatOffHeapAccess(lContiguousMemoryInterface);
  ...
  {
    @SuppressWarnings("unchecked")
    final OffHeapPlanarImg<T, IntOffHeapAccess> lOffHeapPlanarImg =
                                                                  (OffHeapPlanarImg<T, IntOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                       dimensions);
    ...
    for (ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      if (mAddSafetyWrapper)
        lContiguousMemoryInterface =
                                   new SafeContiguousMemory(lContiguousMemoryInterface);
      final IntOffHeapAccess lIntOffHeapAccess =
                                               new IntOffHeapAccess(lContiguousMemoryInterface);
  ...
  {
    @SuppressWarnings("unchecked")
    final OffHeapPlanarImg<T, LongOffHeapAccess> lOffHeapPlanarImg =
                                                                   (OffHeapPlanarImg<T, LongOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                         dimensions);
    ...
    for (ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      if (mAddSafetyWrapper)
        lContiguousMemoryInterface =
                                   new SafeContiguousMemory(lContiguousMemoryInterface);
      final LongOffHeapAccess lLongOffHeapAccess =
                                                 new LongOffHeapAccess(lContiguousMemoryInterface);
  ...
  {
    @SuppressWarnings("unchecked")
    final OffHeapPlanarImg<T, ShortOffHeapAccess> lOffHeapPlanarImg =
                                                                    (OffHeapPlanarImg<T, ShortOffHeapAccess>) type.createSuitableNativeImg(this,
                                                                                                                                           dimensions);

    int i = 0;
    for (final ContiguousMemoryInterface lContiguousMemoryInterface : pFragmentedMemory)
    {
      final ShortOffHeapAccess lShortOffHeapAccess =
                                                   new ShortOffHeapAccess(lContiguousMemoryInterface);
