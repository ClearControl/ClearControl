...
public class BasicSampleSimulator implements SampleSimulatorInterface {
    ...
    public  static BasicSampleSimulator getBasicSampleSimulatorWithASingleStackFromARawFile(String pPathToFile, long[]
            pDimensions){
        try {
...
//            // assuming short
            ...
            short[] arr = loadUnsignedShortSampleSpaceFromDisk(pPathToFile, (int)pDimensions[0], (int)pDimensions[1],
                    (int)pDimensions[2]);
            OffHeapMemory cm = new OffHeapMemory("mem", bss, OffHeapMemoryAccess.allocateMemory(
                    (2*pDimensions[0]*pDimensions[1]*pDimensions[2])), pDimensions[0]*pDimensions[1]*pDimensions[2]);
