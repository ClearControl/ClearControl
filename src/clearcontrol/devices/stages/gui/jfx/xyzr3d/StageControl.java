...
import clearcontrol.devices.stages.gui.jfx.xyzr3d.controls.CircleIndicator;
...
public class StageControl
{
  ...
  public void init()
  {
    ...
    final Label xStageValue =
                            new Label(Double.toString(xStageSlider.getValue()));

    xStageSlider.valueProperty()
                .addListener((observable, oldValue, newValue) -> {
                  xStageValue.setText(String.format("%d",
                                                    newValue.intValue()));
    ...
    final Label yStageValue =
                            new Label(Double.toString(yStageSlider.getValue()));
    ...
    final Label zStageValue =
                            new Label(Double.toString(zStageSlider.getValue()));
    ...
    stackPane.getChildren().addAll(VBoxBuilder.create()
                                              .spacing(10)
