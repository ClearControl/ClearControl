                       ...
                       AsynchronousExecutorServiceAccess
{
  ...
  private final Variable<LightSheetAcquisitionStateInterface> mStackAcquisitionVariable =
                                                                                        new Variable<LightSheetAcquisitionStateInterface>("StackAcquisition",
                                                                                                                                          null);
  ...
  private HashMap<Function<Void, Boolean>, Long> mTimmingMap =
                                                             new HashMap<>();
  ...
  private boolean time(Function<Void, Boolean> pMethod)
  {
    ...
    double lElpasedTimeInMilliseconds =
                                      TimeUnit.MILLISECONDS.convert(lElapsedTimeInNS,
