                                          ...
                                          AcquisitionStateInterface<LightSheetMicroscopeInterface>
{
  ...
  public double getDZ(int pPlaneIndex, int pDeviceIndex)
  {
    ...
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.DZ,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public double getIX(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IX,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public double getIY(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IY,
                                                                         pDeviceIndex,
                                                                         lRamp);
    return lInterpolatedValue;
  }
  ...
  public double getIZ(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IZ,
                                                                         pDeviceIndex,
                                                                         lRamp);
    return lRamp + lInterpolatedValue;
  }
  ...
  public double getIA(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IA,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public double getIB(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IB,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public double getIW(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IW,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public double getIH(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IH,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public double getIP(int pPlaneIndex, int pDeviceIndex)
  {
    final double lRamp = getZRamp(pPlaneIndex);
    final double lInterpolatedValue =
                                    mInterpolationTables.getInterpolated(LightSheetDOF.IP,
                                                                         pDeviceIndex,
                                                                         lRamp);
  ...
  public int getBestDetectionArm(int pControlPlaneIndex)
  {
    ...
    double lTransitionPlane =
                            mInterpolationTables.getTransitionPlane();
