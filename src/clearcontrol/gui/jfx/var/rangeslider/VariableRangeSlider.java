...
public class VariableRangeSlider<T extends Number> extends HBox
{
																...
																Number pNewValue)
	{
		...
		{
			double lCorrectedValueDouble = pIsLow	? correctLowValueDouble(pNewValue.doubleValue())
																						: correctHighValueDouble(pNewValue.doubleValue());
			long lCorrectedValueLong = pIsLow	? correctLowValueLong(pNewValue.longValue())
	...
	private long correctLowValueLong(long pValue)
	{
		...
		if (mGranularity.get() != null)
		{
			...
			long lCorrectedValue = lGranularity * Math.round(1.0 * pValue
																												/ lGranularity);
			return lCorrectedValue;
		}
	...
	{
		double lCorrectedValue = correctLowValueDouble(pDoubleValue.doubleValue());
	...
	{
		double lCorrectedValue = correctHighValueDouble(pDoubleValue.doubleValue());
