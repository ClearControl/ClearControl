...
public class RadialBargraphBuilder<B extends RadialBargraphBuilder<B>>
{
  ...
  {
    properties.put("sectionsArray",
                   new SimpleObjectProperty<>(SECTIONS));
    return this;
  }

  public final RadialBargraphBuilder sections(final List<Section> SECTIONS)
  {
    properties.put("sectionsList",
                   new SimpleObjectProperty<>(SECTIONS));
    return this;
  }
  ...
  {
    properties.put("markersArray",
                   new SimpleObjectProperty<>(MARKERS));
    return this;
  }

  public final RadialBargraphBuilder markers(final List<Marker> MARKERS)
  {
    properties.put("markersList",
                   new SimpleObjectProperty<>(MARKERS));
    return this;
  }
  ...
  {
    properties.put("animationDuration",
                   new SimpleDoubleProperty(ANIMATION_DURATION));
    return this;
  }

  public final RadialBargraphBuilder minMeasuredValueVisible(final boolean MIN_MEASURED_VALUE_VISIBLE)
  {
    properties.put("minMeasuredValueVisible",
                   new SimpleBooleanProperty(MIN_MEASURED_VALUE_VISIBLE));
    return this;
  }

  public final RadialBargraphBuilder maxMeasuredValueVisible(final boolean MAX_MEASURED_VALUE_VISIBLE)
  {
    properties.put("maxMeasuredValueVisible",
  ...
  {
    properties.put("thresholdVisible",
                   new SimpleBooleanProperty(THRESHOLD_VISIBLE));
    return this;
  }

  public final RadialBargraphBuilder startAngle(final double START_ANGLE)
  {
    properties.put("startAngle",
                   new SimpleDoubleProperty(START_ANGLE));
    return this;
  }

  public final RadialBargraphBuilder angleRange(final double ANGLE_RANGE)
  {
    properties.put("angleRange",
                   new SimpleDoubleProperty(ANGLE_RANGE));
    return this;
  }

  public final RadialBargraphBuilder autoScale(final boolean AUTO_SCALE)
  {
    properties.put("autoScale",
                   new SimpleBooleanProperty(AUTO_SCALE));
    return this;
  }
  ...
  public final RadialBargraphBuilder numberFormat(final eu.hansolo.enzo.gauge.RadialBargraph.NumberFormat NUMBER_FORMAT)
  {
    properties.put("numberFormat",
                   new SimpleObjectProperty<>(NUMBER_FORMAT));
    return this;
  }

  public final RadialBargraphBuilder minorTickSpace(final double MINOR_TICK_SPACE)
  {
    properties.put("minorTickSpace",
                   new SimpleDoubleProperty(MINOR_TICK_SPACE));
    return this;
  }

  public final RadialBargraphBuilder plainValue(final boolean PLAIN_VALUE)
  {
    properties.put("plainValue",
                   new SimpleBooleanProperty(PLAIN_VALUE));
    return this;
  }

  public final RadialBargraphBuilder tickLabelFill(final Color TICK_LABEL_FILL)
  {
    properties.put("tickLabelFill",
                   new SimpleObjectProperty<>(TICK_LABEL_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill0(final Color SECTION_0_FILL)
  {
    properties.put("sectionFill0",
                   new SimpleObjectProperty<>(SECTION_0_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill1(final Color SECTION_1_FILL)
  {
    properties.put("sectionFill1",
                   new SimpleObjectProperty<>(SECTION_1_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill2(final Color SECTION_2_FILL)
  {
    properties.put("sectionFill2",
                   new SimpleObjectProperty<>(SECTION_2_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill3(final Color SECTION_3_FILL)
  {
    properties.put("sectionFill3",
                   new SimpleObjectProperty<>(SECTION_3_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill4(final Color SECTION_4_FILL)
  {
    properties.put("sectionFill4",
                   new SimpleObjectProperty<>(SECTION_4_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill5(final Color SECTION_5_FILL)
  {
    properties.put("sectionFill5",
                   new SimpleObjectProperty<>(SECTION_5_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill6(final Color SECTION_6_FILL)
  {
    properties.put("sectionFill6",
                   new SimpleObjectProperty<>(SECTION_6_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill7(final Color SECTION_7_FILL)
  {
    properties.put("sectionFill7",
                   new SimpleObjectProperty<>(SECTION_7_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill8(final Color SECTION_8_FILL)
  {
    properties.put("sectionFill8",
                   new SimpleObjectProperty<>(SECTION_8_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionFill9(final Color SECTION_9_FILL)
  {
    properties.put("sectionFill9",
                   new SimpleObjectProperty<>(SECTION_9_FILL));
    return this;
  }

  public final RadialBargraphBuilder markerFill0(final Color MARKER_0_FILL)
  {
    properties.put("markerFill0",
                   new SimpleObjectProperty<>(MARKER_0_FILL));
    return this;
  }

  public final RadialBargraphBuilder markerFill1(final Color MARKER_1_FILL)
  {
    properties.put("markerFill1",
                   new SimpleObjectProperty<>(MARKER_1_FILL));
    return this;
  }

  public final RadialBargraphBuilder markerFill2(final Color MARKER_2_FILL)
  {
    properties.put("markerFill2",
                   new SimpleObjectProperty<>(MARKER_2_FILL));
    return this;
  }

  public final RadialBargraphBuilder markerFill3(final Color MARKER_3_FILL)
  {
    properties.put("markerFill3",
                   new SimpleObjectProperty<>(MARKER_3_FILL));
    return this;
  }

  public final RadialBargraphBuilder markerFill4(final Color MARKER_4_FILL)
  {
    properties.put("markerFill4",
                   new SimpleObjectProperty<>(MARKER_4_FILL));
    return this;
  }

  public final RadialBargraphBuilder sectionsVisible(final boolean SECTIONS_VISIBLE)
  {
    properties.put("sectionsVisible",
                   new SimpleBooleanProperty(SECTIONS_VISIBLE));
    return this;
  }

  public final RadialBargraphBuilder markersVisible(final boolean MARKERS_VISIBLE)
  {
    properties.put("markersVisible",
                   new SimpleBooleanProperty(MARKERS_VISIBLE));
    return this;
  }
  ...
  {
    properties.put("prefSize",
                   new SimpleObjectProperty<>(new Dimension2D(WIDTH,
                                                              HEIGHT)));
    return (B) this;
  }
  ...
  {
    properties.put("prefHeight",
                   new SimpleDoubleProperty(PREF_HEIGHT));
    return (B) this;
  }
  ...
  {
    properties.put("translateX",
                   new SimpleDoubleProperty(TRANSLATE_X));
    return (B) this;
  }

  public final B translateY(final double TRANSLATE_Y)
  {
    properties.put("translateY",
                   new SimpleDoubleProperty(TRANSLATE_Y));
    return (B) this;
  }
  ...
  public final RadialBargraph build()
  {
    ...
    for (String key : properties.keySet())
    {
      ...
      {
        Dimension2D dim =
                        ((ObjectProperty<Dimension2D>) properties.get(key)).get();
      ...
      else if ("styleClass".equals(key))
      {
        ...
        CONTROL.getStyleClass()
               .addAll(((ObjectProperty<String[]>) properties.get(key)).get());
      }
      ...
      {
        CONTROL.setNumberFormat(((ObjectProperty<eu.hansolo.enzo.gauge.RadialBargraph.NumberFormat>) properties.get(key)).get());
      }
