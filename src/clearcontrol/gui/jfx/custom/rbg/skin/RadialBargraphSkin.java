package clearcontrol.gui.jfx.custom.rbg.skin;
 ...
 * 15:35
 */
public class RadialBargraphSkin extends SkinBase<RadialBargraph>
                                implements Skin<RadialBargraph>
{
  ...
  public RadialBargraphSkin(RadialBargraph radialBargraph)
  {
    ...
    angleStep = radialBargraph.getAngleRange()
                / (radialBargraph.getMaxValue()
                   - radialBargraph.getMinValue());
    angle = new SimpleDoubleProperty(this,
                                     "angle",
  ...
  private void init()
  {
    ...
    {
      if (getSkinnable().getPrefWidth() < 0
          && getSkinnable().getPrefHeight() < 0)
      {
  ...
  {
    Font.loadFont(getClass().getResourceAsStream("/eu/hansolo/enzo/fonts/opensans-semibold.ttf"),
                  (0.06 * PREFERRED_HEIGHT)); // "OpenSans"
    ...
    maxMeasuredValueRotate =
                           new Rotate(180
                                      - getSkinnable().getStartAngle());
    maxMeasuredValue.getTransforms().setAll(maxMeasuredValueRotate);
    maxMeasuredValue.setOpacity(getSkinnable().isMaxMeasuredValueVisible() ? 1
                                                                           : 0);
    ...
    thresholdRotate =
                    new Rotate(180 - getSkinnable().getStartAngle());
    ...
    bar.setStroke(null);
    bar.setFill(new RadialGradient(0,
                                   0,
                                   PREFERRED_WIDTH * 0.5,
                                   PREFERRED_HEIGHT * 0.5,
                                   PREFERRED_WIDTH * 0.45,
                                   false,
                                   CycleMethod.NO_CYCLE,
                                   new Stop(0.0, barColor),
                                   new Stop(0.76,
                                            barColor.deriveColor(-5,
                                                                 1,
                                                                 1,
                                                                 1)), // -5
                                                                      // for
    ...
    // Set initial value
    double range = (getSkinnable().getMaxValue()
    ...
    value.setText(String.format(Locale.US,
                                "%." + getSkinnable().getDecimals()
                                           + "f",
                                currentValue));
    value.setTranslateX((size - value.getLayoutBounds().getWidth())
                        * 0.5);
    bar.setLength(-currentValue * angleStep);

    clickRegion = new Region();
    clickRegion.setBackground(new Background(new BackgroundFill(Color.TRANSPARENT,
                                                                CornerRadii.EMPTY,
                                                                Insets.EMPTY)));
  ...
  private void registerListeners()
  {
    getSkinnable().widthProperty()
                  .addListener(observable -> handleControlPropertyChanged("RESIZE"));
    getSkinnable().heightProperty()
                  .addListener(observable -> handleControlPropertyChanged("RESIZE"));
    getSkinnable().valueProperty()
                  .addListener(observable -> handleControlPropertyChanged("VALUE"));
    getSkinnable().minValueProperty()
                  .addListener(observable -> handleControlPropertyChanged("RECALC"));
    getSkinnable().maxValueProperty()
                  .addListener(observable -> handleControlPropertyChanged("RECALC"));
    getSkinnable().minMeasuredValueProperty()
                  .addListener(observable -> handleControlPropertyChanged("MIN_MEASURED_VALUE"));
    getSkinnable().minMeasuredValueVisibleProperty()
                  .addListener(observable -> handleControlPropertyChanged("MIN_MEASURED_VALUE_VISIBLE"));
    getSkinnable().maxMeasuredValueProperty()
                  .addListener(observable -> handleControlPropertyChanged("MAX_MEASURED_VALUE"));
    getSkinnable().maxMeasuredValueVisibleProperty()
                  .addListener(observable -> handleControlPropertyChanged("MAX_MEASURED_VALUE_VISIBLE"));
    getSkinnable().barColorProperty()
                  .addListener(observable -> handleControlPropertyChanged("BAR_COLOR"));
    getSkinnable().animatedProperty()
                  .addListener(observable -> handleControlPropertyChanged("ANIMATED"));
    getSkinnable().thresholdProperty()
                  .addListener(observable -> handleControlPropertyChanged("THRESHOLD"));
    getSkinnable().thresholdVisibleProperty()
                  .addListener(observable -> handleControlPropertyChanged("THRESHOLD_VISIBLE"));
    getSkinnable().angleRangeProperty()
                  .addListener(observable -> handleControlPropertyChanged("ANGLE_RANGE"));
    getSkinnable().numberFormatProperty()
                  .addListener(observable -> handleControlPropertyChanged("RECALC"));
    getSkinnable().plainValueProperty()
                  .addListener(observable -> handleControlPropertyChanged("PLAIN_VALUE"));
    getSkinnable().interactiveProperty()
                  .addListener(observable -> handleControlPropertyChanged("INTERACTIVE"));
    getSkinnable().getSections()
                  .addListener((ListChangeListener<Section>) change -> handleControlPropertyChanged("CANVAS_REFRESH"));
    getSkinnable().getMarkers()
                  .addListener((MapChangeListener<Marker, Rotate>) change -> handleControlPropertyChanged("MARKER"));
    getSkinnable().barGradientProperty()
                  .addListener((ListChangeListener<Stop>) change -> handleControlPropertyChanged("BAR_GRADIENT"));
    getSkinnable().barGradientEnabledProperty()
                  .addListener(observable -> handleControlPropertyChanged("BAR_COLOR"));
  ...
  protected void handleControlPropertyChanged(final String PROPERTY)
  {
    ...
    else if ("VALUE".equals(PROPERTY))
    {
      withinSpeedLimit = !(Instant.now()
                                  .minusMillis((long) getSkinnable().getAnimationDuration())
                                  .isBefore(lastCall));
      lastCall = Instant.now();
      setBar();
    }
    ...
    {
      angleStep = getSkinnable().getAngleRange()
        ...
        public void run()
        {
          ...
          value.setText(String.format(Locale.US,
                                      "%." + getSkinnable().getDecimals()
                                                 + "f",
                                      currentValue));
          value.setTranslateX((size
                               - value.getLayoutBounds().getWidth())
                              * 0.5);
          bar.setLength(-currentValue * angleStep);
    ...
    {
      thresholdRotate.setAngle(getSkinnable().getThreshold()
                               * angleStep - 180
                               - getSkinnable().getStartAngle());
    }
    else if ("THRESHOLD_VISIBLE".equals(PROPERTY))
    {
      threshold.setOpacity(getSkinnable().isThresholdVisible() ? 1
                                                               : 0);
      threshold.setManaged(getSkinnable().isThresholdVisible());
    }
    ...
    else if ("MARKER".equals(PROPERTY))
    {
      ...
      for (Marker marker : getSkinnable().getMarkers().keySet())
      {
        if (pane.getChildren().contains(marker))
          continue;
  ...
  private void checkForRemovedMarkers()
  {
    ...
    for (Node node : pane.getChildren())
    {
      if (node instanceof Marker)
      {
        ...
        node.removeEventHandler(MouseEvent.MOUSE_PRESSED,
                                mouseEventHandler);
        node.removeEventHandler(MouseEvent.MOUSE_DRAGGED,
                                mouseEventHandler);
        node.removeEventHandler(MouseEvent.MOUSE_RELEASED,
                                mouseEventHandler);
        node.removeEventHandler(TouchEvent.TOUCH_PRESSED,
                                touchEventHandler);
        node.removeEventHandler(TouchEvent.TOUCH_MOVED,
                                touchEventHandler);
        node.removeEventHandler(TouchEvent.TOUCH_RELEASED,
                                touchEventHandler);
        markersToRemove.add(node);
      }
    }
    for (Node node : markersToRemove)
  ...
  private void handleMouseEvent(final MouseEvent MOUSE_EVENT)
  {
    ...
    if (getSkinnable().isInteractive() && SRC.equals(threshold))
    {
      if (MouseEvent.MOUSE_PRESSED == TYPE)
      {
        ...
        value.setText(String.format(Locale.US,
                                    "%." + getSkinnable().getDecimals()
                                               + "f",
                                    getSkinnable().getThreshold()));
        resizeText();
      }
      else if (MouseEvent.MOUSE_DRAGGED == TYPE)
      {
        Point2D point =
                      getSkinnable().sceneToLocal(MOUSE_EVENT.getSceneX(),
                                                  MOUSE_EVENT.getSceneY());
    ...
    else if (getSkinnable().isInteractive()
             && SRC.equals(minMeasuredValue))
    {
      if (MouseEvent.MOUSE_PRESSED == TYPE)
      {
        unit.setText("Min");
        value.setText(String.format(Locale.US,
                                    "%." + getSkinnable().getDecimals()
                                               + "f",
                                    getSkinnable().getMinMeasuredValue()));
        resizeText();
      }
      else if (MouseEvent.MOUSE_RELEASED == TYPE)
      {
             ...
             && SRC.equals(maxMeasuredValue))
    {
      if (MouseEvent.MOUSE_PRESSED == TYPE)
      {
        ...
        value.setText(String.format(Locale.US,
                                    "%." + getSkinnable().getDecimals()
                                               + "f",
                                    getSkinnable().getMaxMeasuredValue()));
        resizeText();
      }
      else if (MouseEvent.MOUSE_RELEASED == TYPE)
      {
             ...
             && SRC.equals(clickRegion))
    {
      ...
      touchRotate(point.getX(),
                  point.getY(),
                  getSkinnable().getMarkers().get(lastMarker));
  ...
  private void handleTouchEvent(final TouchEvent TOUCH_EVENT)
  {
    ...
    if (SRC.equals(threshold))
    {
      ...
      {
        Point2D point =
                      getSkinnable().sceneToLocal(TOUCH_EVENT.getTouchPoint()
                                                             .getSceneX(),
                                                  TOUCH_EVENT.getTouchPoint()
                                                             .getSceneY());
        touchRotate(point.getX(), point.getY(), thresholdRotate);
      }
    ...
    else if (TouchEvent.TOUCH_PRESSED == TYPE
             && SRC.equals(clickRegion))
    {
      Point2D point =
                    getSkinnable().sceneToLocal(TOUCH_EVENT.getTouchPoint()
  ...
  {
    double deltaX = x - (getSkinnable().getWidth() * 0.5);
    double deltaY = y - (getSkinnable().getHeight() * 0.5);
  ...
  private void touchRotate(final double X,
                           final double Y,
                           final Rotate ROTATE)
  {
    double theta = getTheta(X, Y);
    interactiveAngle = (theta + 90) % 360;
    double newValue = Double.compare(interactiveAngle,
                                     180) <= 0 ? (interactiveAngle
                                                  + 180.0
                                                  + getSkinnable().getStartAngle()
                                                  - 360)
                                                 / angleStep
                                               : (interactiveAngle
                                                  ...
                                                  - 360)
                                                 / angleStep;
    if (Double.compare(newValue, getSkinnable().getMinValue()) >= 0
        && Double.compare(newValue,
                          getSkinnable().getMaxValue()) <= 0)
    {
  ...
  {
    FadeTransition fadeUnitOut =
                               new FadeTransition(Duration.millis(425),
                                                  unit);
    fadeUnitOut.setFromValue(1.0);
    fadeUnitOut.setToValue(0.0);
    FadeTransition fadeValueOut =
                                new FadeTransition(Duration.millis(425),
                                                   value);
    ...
    FadeTransition fadeUnitIn =
                              new FadeTransition(Duration.millis(425),
                                                 unit);
    fadeUnitIn.setFromValue(0.0);
    fadeUnitIn.setToValue(1.0);
    FadeTransition fadeValueIn =
                               new FadeTransition(Duration.millis(425),
                                                  value);
    fadeValueIn.setFromValue(0.0);
    fadeValueIn.setToValue(1.0);
    ParallelTransition parallelIn =
                                  new ParallelTransition(fadeUnitIn,
                                                         fadeValueIn);

    ParallelTransition parallelOut =
                                   new ParallelTransition(fadeUnitOut,
                                                          fadeValueOut);
    ...
    SequentialTransition sequence =
                                  new SequentialTransition(parallelOut,
                                                           pause,
                                                           parallelIn);
    sequence.play();
  }
  ...
  private void setBar()
  {
    ...
    {
      timeline.stop();
      final KeyValue KEY_VALUE = new KeyValue(angle,
                                              targetAngle,
                                              Interpolator.SPLINE(0.5,
                                                                  0.4,
                                                                  0.4,
                                                                  1.0));
      final KeyFrame KEY_FRAME =
                               new KeyFrame(Duration.millis(getSkinnable().getAnimationDuration()),
                                            KEY_VALUE);
  ...
  private void drawTickMarks(final GraphicsContext CTX)
  {
    ...
    boolean smallRange = getSkinnable().getMaxValue()
                         - getSkinnable().getMinValue() < 10;
    double tmpMinValue =
                       smallRange ? getSkinnable().getMinValue() * 10
                                  : getSkinnable().getMinValue();
    double tmpMaxValue =
                       smallRange ? getSkinnable().getMaxValue() * 10
                                  : getSkinnable().getMaxValue();
    double tmpAngleStep = smallRange ? angleStep / 10 : angleStep;
    for (double angle =
                      0, counter =
                                 tmpMinValue; Double.compare(counter,
                                                             tmpMaxValue) <= 0; angle -=
                                                                                      tmpAngleStep, counter++)
    {
      sinValue = Math.sin(Math.toRadians(angle + startAngle));
      cosValue = Math.cos(Math.toRadians(angle + startAngle));

      Point2D innerPoint = new Point2D(center.getX()
                                       + size * 0.388 * sinValue,
                                       center.getY() + size * 0.388
                                                       * cosValue);
      Point2D outerPoint = new Point2D(center.getX()
                                       + size * 0.485 * sinValue,
                                       center.getY() + size * 0.485
                                                       * cosValue);
      ...
      if (counter % getSkinnable().getMinorTickSpace() == 0)
      {
        ...
        CTX.strokeLine(innerPoint.getX(),
                       innerPoint.getY(),
                       outerPoint.getX(),
                       outerPoint.getY());
      }
  ...
  private final void drawSections(final GraphicsContext CTX)
  {
    ...
    IntStream.range(0, getSkinnable().getSections().size())
             .parallel()
             .forEachOrdered(i -> {
               final Section SECTION = getSkinnable().getSections()
                                                     .get(i);
               final double SECTION_START_ANGLE;
               if (Double.compare(SECTION.getStart(), MAX_VALUE) <= 0
                   && Double.compare(SECTION.getStop(),
                                     MIN_VALUE) >= 0)
               {
                 if (SECTION.getStart() < MIN_VALUE
                     && SECTION.getStop() < MAX_VALUE)
                 {
                   SECTION_START_ANGLE = MIN_VALUE * angleStep;
                 }
                 else
                 {
                   SECTION_START_ANGLE = (SECTION.getStart()
                                          - MIN_VALUE)
                                         * angleStep;
                 }
                 ...
                 {
                   SECTION_ANGLE_EXTEND = (MAX_VALUE
                                           - SECTION.getStart())
                                          * angleStep;
                 }
                 else
                 {
                   SECTION_ANGLE_EXTEND = (SECTION.getStop()
                                           - SECTION.getStart())
                                          * angleStep;
                 }
                 ...
                 CTX.strokeArc(xy,
                               ...
                               wh,
                               wh,
                               -(OFFSET + SECTION_START_ANGLE),
                               -SECTION_ANGLE_EXTEND,
                               ArcType.OPEN);
                 CTX.restore();
               }
             });
  ...
  private final void drawMarkers()
  {
    for (Marker marker : getSkinnable().getMarkers().keySet())
    {
      ...
      marker.relocate((size - marker.getPrefWidth()) * 0.5,
                      size * 0.04);
      getSkinnable().getMarkers()
                    .get(marker)
                    .setPivotX(marker.getPrefWidth() * 0.5);
      getSkinnable().getMarkers().get(marker).setPivotY(size * 0.46);
      getSkinnable().getMarkers()
                    .get(marker)
                    .setAngle(marker.getValue() * angleStep - 180
                              - getSkinnable().getStartAngle());
    }
  }
  ...
  private void recalculateBarGradient()
  {
    ...
    double offset =
                  angleFactor * ((360 - getSkinnable().getStartAngle()
                                  + 180
                                  - emptyRange * 0.5)
                                 % 360);
    ...
    {
      stops.add(new Stop((maxFraction - minFraction) * 0.5,
                         (Color) Interpolator.LINEAR.interpolate(minFractionColor,
                                                                 maxFractionColor,
                                                                 0.5)));
    }
    for (Stop stop : getSkinnable().getBarGradient())
    {
      if (Double.compare(stop.getOffset(), minFraction) == 0
          || Double.compare(stop.getOffset(), maxFraction) == 0)
        continue;
      stops.add(stop);
    }
    barGradient = new ConicalGradient(
                                      new Point2D(size * 0.5,
                                                  size * 0.5),
                                      offset,
                                      stops);
  }
  ...
  private void resizeText()
  {
    ...
    title.setTranslateX((size - title.getLayoutBounds().getWidth())
                        * 0.5);
    title.setTranslateY(size * 0.3);

    unit.setFont(Fonts.robotoMedium(size * 0.1));
    unit.setTranslateX((size - unit.getLayoutBounds().getWidth())
                       * 0.5);
  ...
  {
    size =
         getSkinnable().getWidth() < getSkinnable().getHeight() ? getSkinnable().getWidth()
    ...
    if (size > 0)
    {
      ...
      pane.relocate((getSkinnable().getWidth() - size) * 0.5,
                    (getSkinnable().getHeight() - size) * 0.5);
      ...
      minMeasuredValue.relocate((size
                                 - minMeasuredValue.getPrefWidth())
                                * 0.5, size * 0.11);
      minMeasuredValueRotate.setPivotX(minMeasuredValue.getPrefWidth()
                                       * 0.5);
      minMeasuredValueRotate.setPivotY(size * 0.39);
      minMeasuredValueRotate.setAngle(getSkinnable().getMinMeasuredValue()
                                      * angleStep - 180
                                      - getSkinnable().getStartAngle());

      maxMeasuredValue.setPrefSize(0.03 * size, 0.03 * size);
      maxMeasuredValue.relocate((size
                                 - maxMeasuredValue.getPrefWidth())
                                * 0.5, size * 0.11);
      maxMeasuredValueRotate.setPivotX(maxMeasuredValue.getPrefWidth()
                                       * 0.5);
      maxMeasuredValueRotate.setPivotY(size * 0.39);
      maxMeasuredValueRotate.setAngle(getSkinnable().getMaxMeasuredValue()
                                      * angleStep - 180
                                      - getSkinnable().getStartAngle());

      threshold.setPrefSize(0.06 * size, 0.055 * size);
      threshold.relocate((size - threshold.getPrefWidth()) * 0.5,
                         size * 0.08);
