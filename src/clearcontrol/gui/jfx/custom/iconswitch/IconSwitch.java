...
public class IconSwitch extends Control implements Toggle
{
		...
		if (null == toggleGroup)
		{
			toggleGroup = new ObjectPropertyBase<ToggleGroup>()
			{
				...
				protected void invalidated()
				{
					...
					if (null != toggleGroup && !toggleGroup.getToggles()
																									.contains(IconSwitch.this))
					{
	...
	{
		private static final CssMetaData<IconSwitch, Paint> SWITCH_COLOR = new CssMetaData<IconSwitch, Paint>("-switch-color",
		...
		private static final CssMetaData<IconSwitch, Paint> THUMB_COLOR = new CssMetaData<IconSwitch, Paint>(	"-thumb-color",
																																																					PaintConverter.getInstance(),
																																																					DEFAULT_THUMB_COLOR)
		{
			@Override
