package clearcontrol.gui.jfx.rangeslider.demo;
...
public class VariableRangeSliderDemo extends Application
{
	...
	public void start(Stage stage)
	{
		...
		Variable<Number> lLowDoubleVariable = new Variable<Number>(	"DemoLowDoubleVar",
																																0.0);
		lLowDoubleVariable.addSetListener((o, n) -> {
			System.out.println("low double: " + n);
		});

		Variable<Number> lHighDoubleVariable = new Variable<Number>("DemoHighDoubleVar",
																																0.0);
		lHighDoubleVariable.addSetListener((o, n) -> {
			System.out.println("high double: " + n);
		});

		VariableRangeSlider<Number> lVariableRangeDoubleSlider = new VariableRangeSlider<Number>("a double value: ",
																																							lLowDoubleVariable,
																																							lHighDoubleVariable,
																																							-1.0,
																																							2.0,
