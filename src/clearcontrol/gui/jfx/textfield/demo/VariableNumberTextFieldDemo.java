package clearcontrol.gui.jfx.textfield.demo;
...
public class VariableNumberTextFieldDemo extends Application
{
	...
	public void start(Stage stage)
	{
		...
		VariableNumberTextField<Number> lVariableDoubleSlider = new VariableNumberTextField<Number>("a double value: ",
																																																lDoubleVariable,
																																																-1.0,
																																																2.0,
																																																0.1);
		...
		VariableNumberTextField<Number> lVariableIntSlider = new VariableNumberTextField<Number>(	"an int value: ",
																																															lIntVariable,
																																															-10,
																																															20,
																																															1);
