                                            ...
                                            StateQueueDeviceInterface
{
  protected Variable<Boolean> mStackMode =
                                         new Variable<Boolean>("StackMode",
                                                               true);

  protected Variable<Boolean> mKeepPlane =
                                         new Variable<Boolean>("KeepPlane",
                                                               true);
  ...
  protected ConcurrentLinkedQueue<TByteArrayList> mKeepAcquiredImageArrayQueue =
                                                                               new ConcurrentLinkedQueue<TByteArrayList>();
