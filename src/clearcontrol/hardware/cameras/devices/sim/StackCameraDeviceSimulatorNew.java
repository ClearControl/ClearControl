    ...
    protected void receivedTrigger() {
        ...
        if (mTriggeCounter.incrementAndGet() >= lDepth)
            ...
            executeAsynchronously(() -> {
                ...
                if (mStackSent != null)
                    try {
                        long lTimeToWait = (mStackDepthVariable.get() * (long)getExposure());
                        System.out.println("time ot wait in microsec:" + lTimeToWait);
                        System.out.println("stack depth:" + mStackDepthVariable.get());
                        System.out.println("exp:" + getExposure() );
                        Thread.sleep(lTimeToWait/1000);
