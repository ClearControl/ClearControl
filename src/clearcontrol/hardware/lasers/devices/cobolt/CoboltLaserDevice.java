package clearcontrol.hardware.lasers.devices.cobolt;
...
import clearcontrol.hardware.lasers.devices.cobolt.adapters.GetCurrentPowerAdapter;
import clearcontrol.hardware.lasers.devices.cobolt.adapters.GetSetTargetPowerAdapter;
import clearcontrol.hardware.lasers.devices.cobolt.adapters.GetWorkingHoursAdapter;
import clearcontrol.hardware.lasers.devices.cobolt.adapters.SetPowerOnOffAdapter;
import clearcontrol.hardware.lasers.devices.cobolt.adapters.protocol.ProtocolCobolt;
import clearcontrol.hardware.lasers.devices.cobolt.models.CoboltDeviceEnum;
