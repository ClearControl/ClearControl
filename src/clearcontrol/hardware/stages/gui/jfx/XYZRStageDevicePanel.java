...
public class XYZRStageDevicePanel extends BorderPane
{
  ...
  private HBox createStageControl(String pLabelString, Stage pStage)
  {
    ...
    case X:
    {
      ...
      double max = cubeScene.getCubeCenterGroup().getTranslateX()
                   + CubeScene.VIEWPORT_SIZE - cubeBB.getMaxX() * 2.2;

      lCurrentSlider.getSlider()
                    .valueProperty()
                    .addListener((observable,
                                  oldValue,
                                  newValue) -> cubeScene.getCubeCenterGroup()
      ...
      cubeScene.getCubeCenterGroup()
               .setTranslateX((lCurrentSlider.getSlider().getValue()
                               + lOffset)
                              * (max - min)
                              / (lCurrentSlider.getSlider().getMax()
                                 + lOffset)
                              + min);
    }
      break;
    case Y:
    {
      ...
      double max = cubeScene.getCubeCenterGroup().getTranslateY()
                   + CubeScene.VIEWPORT_SIZE - cubeBB.getMaxY() * 2.2;
      ...
      cubeScene.getCubeCenterGroup()
               .setTranslateY((lCurrentSlider.getSlider().getValue()
                               + lOffset)
                              * (max - min)
                              / (lCurrentSlider.getSlider().getMax()
                                 + lOffset)
    ...
    case Z:
    {
      ...
      double max = cubeScene.getCubeCenterGroup().getTranslateZ()
                   + CubeScene.VIEWPORT_SIZE - cubeBB.getMaxZ() * 2.2;
      ...
      lCurrentSlider.getSlider()
                    ...
                    .addListener((observable,
                                  oldValue,
                                  newValue) -> cubeScene.getCubeCenterGroup()
                                                        .setTranslateZ((newValue.doubleValue()
                                                                        + lOffset)
                                                                       * (max
                                                                          - min)
                                                                       / (lCurrentSlider.getSlider()
      ...
      cubeScene.getCubeCenterGroup()
               .setTranslateZ((lCurrentSlider.getSlider().getValue()
                               + lOffset)
                              * (max - min)
                              / (lCurrentSlider.getSlider().getMax()
                                 + lOffset)
