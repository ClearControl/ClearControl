package clearcontrol.hardware.stages.gui.jfx.xyzr3d;
...
import clearcontrol.hardware.stages.gui.jfx.xyzr3d.object.Axes;
import clearcontrol.hardware.stages.gui.jfx.xyzr3d.object.Cube;
...
public class CubeScene extends View3D
{
  ...
  private static final String xPlus =
                                    CubeScene.class.getResource("images/Xplus.png")
                                                   .toString();
  private static final String xMinus =
                                     CubeScene.class.getResource("images/XMinus.png")
                                                    .toString();

  private static final String yPlus =
                                    CubeScene.class.getResource("images/Yplus.png")
                                                   .toString();
  private static final String yMinus =
                                     CubeScene.class.getResource("images/YMinus.png")
                                                    .toString();

  private static final String zPlus =
                                    CubeScene.class.getResource("images/Zplus.png")
                                                   .toString();
  private static final String zMinus =
                                     CubeScene.class.getResource("images/ZMinus.png")
                                                    .toString();
  ...
  public void createBaseScene()
  {
    ...
    Box stageBox =
                 new Box(VIEWPORT_SIZE, VIEWPORT_SIZE, VIEWPORT_SIZE);
    ...
    Group stageGroup =
                     new Group(cubeCenterGroup, axisGroup, stageBox);
    ...
    BoundingBox cubeBinL =
                         (BoundingBox) stageGroup.getBoundsInLocal();
    stageGroup.setTranslateX(-(cubeBinL.getMinX()
                               + cubeBinL.getMaxX())
                             / 2.0);
    stageGroup.setTranslateY(-(cubeBinL.getMinY()
                               + cubeBinL.getMaxY())
                             / 2.0);
    stageGroup.setTranslateZ(-(cubeBinL.getMinZ()
                               + cubeBinL.getMaxZ())
                             / 2.0);

    sceneDiameter = Math.sqrt(Math.pow(cubeBinL.getWidth(), 2)
                              + Math.pow(cubeBinL.getHeight(), 2)
                             ...
                             final SceneAntialiasing sceneAA)
  {
    ...
    subScene =
             new SubScene(subSceneRoot, width, height, true, sceneAA);
