package clearcontrol.hardware.stages.gui.swing;
...
public class StagePanel extends JPanel
{
                    ...
                    LightSheetInterface pLightSheetSignalGenerator)
  {
    ...
    mStageXSliderDouble =
                        new JSliderDouble("Sample Stage X (microns)",
                                          -10000,
                                          10000,
                                          0);
    ...
    mStageYSliderDouble =
                        new JSliderDouble("Sample Stage Y (microns)",
                                          -10000,
                                          10000,
                                          0);
    ...
    mStageZSliderDouble =
                        new JSliderDouble("Sample Stage Z (microns)",
                                          -10000,
                                          10000,
                                          0);
    ...
    mStageRSliderDouble =
                        new JSliderDouble("Sample Stage R (micro-degrees)",
                                          -360000,
                                          360000,
                                          0);
    ...
    if (pRequestUpdateVariableListener != null
        && pLightSheetSignalGenerator != null)
    {
      // OUTDATED:
