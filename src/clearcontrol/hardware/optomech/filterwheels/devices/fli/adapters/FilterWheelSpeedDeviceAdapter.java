package clearcontrol.hardware.optomech.filterwheels.devices.fli.adapters;
																					...
																					FilterWheelDeviceAdapter
{
	...
	@Override
	public byte[] getSetValueCommandMessage(final Integer pOldSpeed,
																					final Integer pNewSpeed)
	{
