...
public class FilterWheelDevicePanelDemo extends Application
{
	...
	{
		FilterWheelDeviceSimulator lFilterWheelDeviceSimulator = new FilterWheelDeviceSimulator("demofilterwheel",
																																														0,
																																														1,
																																														2,
																																														3);
		...
		FilterWheelDevicePanel lFilterWheelDevicePanel = new FilterWheelDevicePanel(lFilterWheelDeviceSimulator);
