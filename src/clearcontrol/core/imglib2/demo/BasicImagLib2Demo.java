package clearcontrol.core.imglib2.demo;
...
public class BasicImagLib2Demo
{
  ...
  public void testByte()
  {
    ...
    for (int z = 0; z < 128; z++)
    {
      final OffHeapMemory lAllocate =
                                    OffHeapMemory.allocateBytes(128
                                                                * 128);
      lFragmentedMemory.add(lAllocate);
    }

    final OffHeapPlanarImgFactory<ByteType> lFactory =
                                                     new OffHeapPlanarImgFactory<ByteType>();

    final NativeImg<ByteType, ByteOffHeapAccess> lOffHeapPlanarImg =
                                                                   lFactory.createByteInstance(lFragmentedMemory,
                                                                                               lDim,
                                                                                               new ByteType());
    ...
    final IntervalView<ByteType> lHyperSlice =
                                             Views.hyperSlice(lOffHeapPlanarImg,
                                                              1,
                                                              100);
  ...
  public void testUnsignedShort() throws InterruptedException
  {
    ...
    {
      final OffHeapMemory lAllocate =
                                    OffHeapMemory.allocateShorts(lDim[0]
                                                                 * lDim[1]
                                                                 * 2);
      lFragmentedMemory.add(lAllocate);
    }

    final OffHeapPlanarImgFactory<UnsignedShortType> lFactory =
                                                              new OffHeapPlanarImgFactory<UnsignedShortType>();

    final NativeImg<UnsignedShortType, ShortOffHeapAccess> lOffHeapPlanarImg =
                                                                             lFactory.createShortInstance(lFragmentedMemory,
                                                                                                          lDim,
                                                                                                          new UnsignedShortType());

    final Cursor<UnsignedShortType> lCursor =
                                            lOffHeapPlanarImg.cursor();
    ...
    final IntervalView<UnsignedShortType> lHyperSlice =
                                                      Views.hyperSlice(lOffHeapPlanarImg,
                                                                       1,
                                                                       lDim[2]
                                                                          / 2);
    ...
    try
    {
      ...
      final RandomAccessible<UnsignedShortType> infiniteImg =
                                                            Views.extendValue(lOffHeapPlanarImg,
                                                                              new UnsignedShortType());
