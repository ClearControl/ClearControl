...
public class ClearControlExecutors
{
  ...
  private static ConcurrentHashMap<Object, SoftReference<CompletingThreadPoolExecutor>> cThreadPoolExecutorMap =
                                                                                                               new ConcurrentHashMap<>(100);
  private static ConcurrentHashMap<Object, SoftReference<ScheduledThreadPoolExecutor>> cScheduledThreadPoolExecutorMap =
                                                                                                                       new ConcurrentHashMap<>(100);

  public static final CompletingThreadPoolExecutor getThreadPoolExecutor(final Object pObject)
  {
    final SoftReference<CompletingThreadPoolExecutor> lSoftReference =
  ...
  {
    final SoftReference<ScheduledThreadPoolExecutor> lSoftReference =
  ...
  {
    SoftReference<CompletingThreadPoolExecutor> lSoftReferenceOnThreadPoolExecutor =
                                                                                   cThreadPoolExecutorMap.get(pObject);

    CompletingThreadPoolExecutor lThreadPoolExecutor;

    if (lSoftReferenceOnThreadPoolExecutor == null
        || lSoftReferenceOnThreadPoolExecutor.get() == null)
    {
      ...
      lSoftReferenceOnThreadPoolExecutor =
                                         new SoftReference<>(lThreadPoolExecutor);
                                                                                         ...
                                                                                         final int pMaxQueueLength)
  {
    ...
    SoftReference<ScheduledThreadPoolExecutor> lSoftReferenceOnThreadPoolExecutor =
                                                                                  cScheduledThreadPoolExecutorMap.get(pObject);
        ...
        || lSoftReferenceOnThreadPoolExecutor.get() == null)
    {
      ...
      lSoftReferenceOnThreadPoolExecutor =
                                         new SoftReference<>(lScheduledThreadPoolExecutor);
      cScheduledThreadPoolExecutorMap.put(pObject,
                                          lSoftReferenceOnThreadPoolExecutor);
    }

    lScheduledThreadPoolExecutor =
                                 lSoftReferenceOnThreadPoolExecutor.get();
