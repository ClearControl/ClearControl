...
public abstract class ChangeListeningBase<E> implements HasChangeListenerInterface<E>
{
	...
	public abstract void addAtControlPlaneIA( int pControlPlaneIndex, int pLightSheetIndex, double lCorrection );

	public abstract void setAtControlPlaneIP( int czi, int l, double v );

	public abstract double getAtControlPlaneIP( int i, int l );

	public abstract void setAtControlPlaneIW( int pControlPlaneIndex, int pLightSheetIndex, Double aDouble );

	public abstract void setAtControlPlaneIX( int pControlPlaneIndex, int pLightSheetIndex, Double aDouble );

	public abstract void addAtControlPlaneIZ( int pControlPlaneIndex, int pLightSheetIndex, double lCorrection );
