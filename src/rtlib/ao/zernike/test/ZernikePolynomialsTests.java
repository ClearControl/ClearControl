...
import rtlib.ao.zernike.ZernikePolynomials;
...
public class ZernikePolynomialsTests
{
	...
	/**
	 * Zernicke radial polynomial R^m_n(x,y) tested against using values
	 * returned Wolfram Alpha's function ZernikeR[0,0,0]
	...
	/**
	 * Zernicke radial polynomial R^m_n(r) tested against values returned
