package rtlib.gui.jfx.slider.behavior;
/*
...
import rtlib.gui.jfx.slider.Slider;
...
public class SliderBehavior extends BehaviorBase<Slider>
{
	...
	/**
	 * Invoked by the Slider {@link javafx.scene.control.Skin} implementation whenever a mouse press
