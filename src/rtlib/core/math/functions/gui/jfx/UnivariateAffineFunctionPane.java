package rtlib.core.math.functions.gui.jfx;
...
public class UnivariateAffineFunctionPane extends StandardGridPane
{
																			...
																			Variable<UnivariateAffineFunction> pFunctionVariable)
	{
		...
		mSlopeTextField = new TextField("" + mFunctionVariable.get()
																													.getSlope());
		...
		mConstantTextField = new TextField("" + mFunctionVariable.get()
																															.getConstant());
		...
		pFunctionVariable.addSetListener((o, n) -> {
			if (o.getSlope() != n.getSlope() || o.getConstant() != n.getConstant())
	...
	private void setFunctionTextField(UnivariateAffineFunction pFunction)
	{
		Platform.runLater(() -> {
			mSlopeTextField.textProperty()
											.set(String.format(	"%." + mPrecision + "f",
																					pFunction.getSlope()));
